...
from config import EXEC_RES_PATH, MIN_WORDS
...
class ANEAAnnotator(Annotator):
    ...
    def _extract_labels(self):
        ...
        outliers_core = set(core_terms) - set().union(*[v for v in list(final_entities.values())])

        # self._save_not_used_labels(init_table_filtered_df, final_entities)
        return final_entities, list(outliers_core)
