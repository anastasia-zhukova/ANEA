...
from graph.node_properties import WikiProperties, WikiLink, Areas
from utils.wordvectors import WordEmbeddings


class Graph:

    def __init__(self, selected_terms):
        self.graph_top_down = {}
        self.graph_down_top = {}
    ...
    def _create_graph(self, selected_terms):
        ...
        terms_grouped = {k:v for k,v in sorted(terms_grouped.items(), reverse=True, key=lambda x: len(x[1]))}
